...
In order to make the searchbar filters the list, I used Javascript functions "filter" and "includes". If the value of input doesn't match with todos, it just simply hides them. 
