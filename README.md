...
In order to make the searchbar filters the list, I used Javascript default functions "filter" and "includes". If the value of input doesn't match with todos, it just simply hides them. 
